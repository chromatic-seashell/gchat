...
#import "GDWAddFriendCell.h"
#import "EMAlertView.h"

@interface GDWAddFriendViewController ()<UITextFieldDelegate,UIAlertViewDelegate>
...
@implementation GDWAddFriendViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    GDWAddFriendCell *cell = (GDWAddFriendCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[GDWAddFriendCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }
...
#warning 以下代码为测试代码，默认用户体系中有一个符合要求的同名用户
        ...
        //判断是否已发来申请
        NSArray *applyArray = [[GDWApplyViewController shareController] dataSource];
